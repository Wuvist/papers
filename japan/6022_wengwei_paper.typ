...
I choose $L$ data provided by Statistics Bureau of Japan as it provides the most comprehensive data since Jan 1953, but it didn't provide average working hours per worker. Thus I use data from OECD, which provide data of OECD countries that may be used for comparison in future studies.

Although Japanese government's official statistics may contains error @stats_error , the fact that such error being revised should add credibility to official statistics.

Bu using Solow-Swan model, Japan's Total Factor Productivity - $A$ could be calculated by:
...
The value of TFP(A) is between 6% ~ 8%. It may looks high comparing to $Y, K, L$, but this is due to the unit chosen for $Y, K, L$. If we change the unit of $L$ from ten thousand hours to one hour, the TFP in 1997 will become $0.03340%$ ($α=0.4$). And if we change the unit of $Y, K$ from billon to a dollar, TFP will become $2107094%$.

It's more important to analyze the CAGR of $A$ comparing to $K, L$, instead of looking at its nominal value for individual years, which could be scaled by choosing a different unit of for $Y, K, L$.
...
In 1998 and 1999, the real GDP growth were negative ($-1.27%, -0.33%$), this is due to the economy shock by Asian financial crisis.
...
The overall CAGR in real GDP under Junichirō Koizumi's administration between 2001 and 2006 is $0.77%$.

Global financial crisis hit Japan heavily in 2008 and 2009. Knowing full well of this impact, Prime Minister at the period - Tarō Asō stats that: "The greatest concern right now is the economy..America is facing a financial crisis ... we must not allow that to bring us down as well." shortly after winning the election. @aso

But Tarō Asō didn't manage to restore Japan's economic health, the real GDP shrunk by $-1.22%$ in 2008 and $-5.69%$ and it resulted in Liberal Democratic Party LDP losing the majority, and Yukio Hatoyama from Democratic Party of Japan became Prime Minister.
...
But if we look at the overall growth of real GDP under Abenomics, the CAGR between 2012 to 2019 (before COVID hits) is only $0.30%$, lower than Koizumi's administration and even lower than the 25 years CAGR ($0.44%$).
...
We could survey on countries that successfully grow to GDP per capita 60K PPP or above, and this level of GDP per capita will make them into the top rank globally.
...
Or, Japan may have already adapted certain strategies to boost GDP per capita in its large cities, but it has a lot more population living rural area to cover.

Prime Minister of Singapore Lee Hsien Loon stated it frankly @pm_lee :
...
Automobile industry is another example, being pioneered in electronic vehicles, Tesla is now the biggest automobile companies in the world. Japan's toyota ranks number two, but Tesla's market cap is bigger than the number 2-9 automobiles combined.
...
Both Apple & Tesla are US companies. It's innovative companies like these gives tremendous growth, and their growth combined drive the overall growth of a country.

Companies needs innovation to create distinctive products that grab the most profit - generate large growth.
...
Although Japanese firms does well in all these industries, but they are seldom the top 1 that could gain the most profit, i.e. contribute to the country's growth by boosting TFP.
...
The typical Japanese culture famous world wide is craftsmanship which best be represented in the documentary Jiro Dreams of Sushi @sushi :
...
Japan will need to have low-wage foreign workers to meets its economic needs, and also welcome high-wage foreign professional to boost TFA. This problem may be eased by having importing foreign worker and firms are adopting @migrant_workers .

The diversified work force may help to drive innovation as well. Both Apple & Tesla have engineers & scientist from all over the world.

== Not only growth

About are just my analysis of potential ways of getting high growth for Japanese economy. But, it's definitely not the only way. Further more gaining high growth may not be the only goals of a country. It may be politician's election campaign goals, but not necessary the needs of ordinary people.
...
Not so bad comparing to other advance economy like UK or US. This is may due to the tradition of firms adapting Nenko System for wage. But, if we look at the wages data more closely, its shows large gender inequality:

#image("gender_wage.png")
#image("atts/income_2008.png")
#image("atts/income_2021.png")

This gender income gap actually dropped if we look at data from 2008 (the earliest data available from Japanese government) and 2021. But The narrowing of the income gap between male & female is due to the decrease of top income male workers, other than the increase of females workers.

This could be due to varies reason, includes but not limited of female Japanese not being ambitious at work and focus on family and possible gender discrimination at work place. But, this may shows potential increase of Japanese's work force. It has half of the work force waiting to be economical incentives and potentially bring innovation and growth.

Ensuring females works with equal pay to man, not only reduce gender inequality in Japan, but will also relief it from relying on new foreign workers, which may bring cultural shocks to the society.

Restructuring of wage systems, may also have impact on income inequality both positively and negatively:
- Higher wage to young workers with bigger contribution will narrow the income gap between young and old generation
- Further increase of wage to high incomer will create bigger gap to the low incomer
...
The stock market if functioned effectively, i.e. allow public listed firms to share profit to wider public via dividend, may have the impact to reduce wealth inequality.
...
Again, this tradition has recently changed, Five Japanese Trading Houses agreed to increase dividends and attract buffect's investment @buffett .
...
Japanese worker's wage barely increase in the pass decades. And again, it has started to change significantly, for example Uniqlo claims to give its employee 40% increment @uniqlo .

A more flexible wage system & profit sharing structure may decrease income & wealth inequality, and incentivize workers and even investors like Buffett. Increase in foreign investment will help to drive economy growth as well.

More importantly when people's income increases, their consumption will also increase, and if CPI is kept at the desired rate of 2%, Japan's economy will finally gets into virtuous circles.

Having a sustainable 2% CPI will allows Japan to move away from monetary policies introduced by Abenomics like quantitative easing, negative interest rate and yield curve control etc.

The low and even negative interest rate and yield curve control has big impact on Japan's exchange rate in the short run. The recent increase of interest rate in US make YEN depreciated, The YEN/USD exchange rate follows closely to the 10y yield gap between US / Japan in the short run @yen_project :
...
The other number worth noting will be the number of homeless person in Japan. I would assuming homeless people in Japan to be the most poor class, or in absolute poverty. And according to Ministry of Health, Labour and Welfare stats, this number has been dropping significantly @homeless:
#image("atts/homeless.png")

Although people moving away from homeless - absolute poverty, their income may still be less than half of the median of equivalent disposable income, i.e. under official poverty line, I would still recognize it to be a big improvement in reducing poverty by decreasing number of homeless person from 25000+ to below 4000 in 2022 @homeless_2022 .

This result is consistent with continuous increment of Japanese government's welfare spending:
